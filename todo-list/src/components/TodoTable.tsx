        ...
        {todos.map((todo) => (
          <tr key={todo.id} className="border-b">
            ...
            <td className="px-4 py-2">
              <Button onClick={() => handleView(todo.id)} >
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M12 4c-5.52 0-10 6-10 6s4.48 6 10 6 10-6 10-6-4.48-6-10-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z"></path>
